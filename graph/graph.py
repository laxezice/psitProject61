...
gender_data = []
percents_data = []
with open('../database/gender18.txt') as csvfile:
    readfile = csv.reader(csvfile, delimiter=',')
...
pie_chart = pygal.Pie()
pie_chart.title = 'By Gender 2018'
pie_chart.add(gender_data[0], percents_data[0])
pie_chart.add(gender_data[1], percents_data[1])
pie_chart.render_to_file('gender2018.svg')
...
age_data = []
percents_data = []
with open('../database/age18.txt') as csvfile:
    readfile = csv.reader(csvfile, delimiter=',')
...
pie_chart.add(age_data[4], percents_data[4])
pie_chart.add(age_data[5], percents_data[5])
pie_chart.render_to_file('age2018.svg')
